...
local function to1BasedIndex(tbl)
	local new = table.move(tbl, 0, #tbl + (tbl[0] and 1 or 0), 1)
	new[0] = nil
	return new
end
...
local function protoConvert(proto, opRemap, opType, opMode)
	...
	proto.code, proto.lines, proto.subs =
		to1BasedIndex(proto.code), to1BasedIndex(proto.lineinfo), to1BasedIndex(proto.p)
	...
	proto.sizecode, proto.sizek, proto.sizelineinfo, proto.sizelocvars, proto.sizep, proto.nups =
		nil, nil, nil, nil, nil, nil -- Clean up garbage values
...
return function(str, env)
	...
	local ran, error = xpcall(function()
		...
		local func = luaY:parser(LuaState, zio, nil, name or "::KA::Loadstring::")
