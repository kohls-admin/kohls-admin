...
All custom commands are part of an [Addon](https://docs.kohl.gg/docs/addons). For this section we will create addons that only create custom commands, but in later parts we will show the extent of what addons can do.
...
To create a custom command, you must register it with the [Registry](https://docs.kohl.gg/api/Registry), using [registerCommand()](https://docs.kohl.gg/api/Registry#registerCommand).
...
`commandDefinition` is a placeholder for the real contents of our command! Commands require a lot of information, structured in a [commandDefinition](https://docs.kohl.gg/api/Registry#CommandDefinition).
