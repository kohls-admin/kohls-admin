...
In this guide, we will use the KA Test Model. You can also explore Kohl's Admin features in the Test Place.

<Tabs>
  <TabItem value="testmodel" label="KA Test Model" default>
    Take the KA Test Model by clicking <a href="https://create.roblox.com/store/asset/18525985332/KA" target="_blank" rel="noopener noreferrer">here</a>.
  </TabItem>
