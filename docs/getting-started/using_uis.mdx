...
- The about section shows the version, our server, the model, donations for special perks, and the credits.
- Our VIP gamepass allows you to have **VIP commands** in participating games!
- Our donation items give you **exclusive titles** in participating games!
- Consider donating to support the ongoing development of Kohl's Admin!
